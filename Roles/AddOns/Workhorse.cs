...
namespace TownOfHost.Roles.AddOns
{
    ...
    {
        private static readonly int Id = 78900;
        ...
        {
            SetupRoleOptions(Id, TabGroup.Addons, CustomRoles.Workhorse, roleSetMode: RoleSettingMode.All);
            OptionAssignOnlyToCrewmate = BooleanOptionItem.Create(Id + 10, "AssignOnlyTo%role%", true, TabGroup.Addons, false).SetParent(CustomRoleSpawnOnOff[CustomRoles.Workhorse]);
            ...
            OptionNumLongTasks = IntegerOptionItem.Create(Id + 11, "WorkhorseNumLongTasks", new(0, 5, 1), 1, TabGroup.Addons, false).SetParent(CustomRoleSpawnOnOff[CustomRoles.Workhorse])
                .SetValueFormat(OptionFormat.Pieces);
            OptionNumShortTasks = IntegerOptionItem.Create(Id + 12, "WorkhorseNumShortTasks", new(0, 5, 1), 1, TabGroup.Addons, false).SetParent(CustomRoleSpawnOnOff[CustomRoles.Workhorse])
                .SetValueFormat(OptionFormat.Pieces);
        }
