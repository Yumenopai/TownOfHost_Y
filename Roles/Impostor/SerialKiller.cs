...
namespace TownOfHost.Roles.Impostor
{
    public static class SerialKiller
    {
        ...
        public static void SetupCustomOption()
        {
            ...
            KillCooldown = FloatOptionItem.Create(Id + 10, "KillCooldown", new(2.5f, 180f, 2.5f), 20f, TabGroup.ImpostorRoles, false).SetParent(CustomRoleSpawnOnOff[CustomRoles.SerialKiller])
                .SetValueFormat(OptionFormat.Seconds);
            TimeLimit = FloatOptionItem.Create(Id + 11, "SerialKillerLimit", new(5f, 900f, 5f), 60f, TabGroup.ImpostorRoles, false).SetParent(CustomRoleSpawnOnOff[CustomRoles.SerialKiller])
                .SetValueFormat(OptionFormat.Seconds);
        }
