            ...
            try
            {
                ...
                _ = new LateTask(() =>
                {
                    try
                    {
                        ...
                        if (AmongUsClient.Instance.IsGamePublic) Utils.SendMessageAutoSplit(string.Format(GetString("Message.AnnounceUsingTOH"), Main.PluginVersion), true, sendTo: client.Character.PlayerId);
